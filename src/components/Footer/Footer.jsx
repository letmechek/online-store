    ...
    return (
      ...
      >
        ...
        >
         ...
         <Box sx={{ px: 2, textAlign: 'center', backgroundColor: (theme) => theme.palette.grey[800], color: theme.palette.common.white, py: 3}}>
            <Container maxWidth="lg">
                <Typography variant="body2">Copyright &copy; {new Date().getFullYear()} My Ecommerce Website</Typography>
